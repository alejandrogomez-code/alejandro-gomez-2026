  ...
  return (
    <Card>
      ...
      <CardContent className="space-y-5">
        ...
        <dl className="grid grid-cols-2 gap-4 border-t border-neutral-100 pt-4 dark:border-neutral-800 sm:grid-cols-3">
          <div>
            <dt className="text-sm text-neutral-500 dark:text-neutral-400">Pasos promedio</dt>
            <dd className="tabular mt-1 text-lg font-medium text-neutral-900 dark:text-neutral-100">
              {formatNumber(current.averageSteps)}
            </dd>
            <Delta value={previous ? current.averageSteps - previous.averageSteps : null} />
          </div>
          <div>
            <dt className="text-sm text-neutral-500 dark:text-neutral-400">Días con objetivo</dt>
            <dd className="tabular mt-1 text-lg font-medium text-neutral-900 dark:text-neutral-100">
              {current.stepGoalDays} / 7
            </dd>
          </div>
          <div>
            <dt className="text-sm text-neutral-500 dark:text-neutral-400">Registros de peso</dt>
            <dd className="tabular mt-1 text-lg font-medium text-neutral-900 dark:text-neutral-100">
        ...
        {habitRows.length > 0 ? (
          <ul className="space-y-2 border-t border-neutral-100 pt-4 dark:border-neutral-800">
            {habitRows.map((row) => (
