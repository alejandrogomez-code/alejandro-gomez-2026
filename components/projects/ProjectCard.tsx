      ...
      >
        ...
        <div className="flex items-start justify-between gap-3">
          <div className="min-w-0">
            ...
            {project.description ? (
              <p className="mt-1 line-clamp-2 text-sm text-sand-500 dark:text-sand-400">
                {project.description}
              </p>
            ) : null}
          </div>
        ...
        <div className="mt-4 space-y-1 text-xs text-sand-500 dark:text-sand-400">
          {nextTask?.due_date ? (
            <p className="truncate">
              Próxima: <span className="text-sand-700 dark:text-sand-200">{nextTask.title}</span>
