...
export const NAV_ITEMS: NavItem[] = [
  ...
  { href: '/objetivos', label: 'Objetivos', icon: Target, match: '/objetivos', accent: 'plum' },
  {
    ...
    accent: 'sage',
    children: [
      { href: '/salud/resumen', label: 'Resumen', icon: ListChecks, match: '/salud/resumen', accent: 'sage' },
      { href: '/salud/peso', label: 'Peso', icon: Scale, match: '/salud/peso', accent: 'ocean' },
      { href: '/salud/pasos', label: 'Pasos', icon: Footprints, match: '/salud/pasos', accent: 'sage' },
      { href: '/salud/habitos', label: 'Hábitos', icon: Repeat, match: '/salud/habitos', accent: 'honey' },
